...
> This was a collaborative group project, completed as part of *PBT205 — Project-based Learning Studio: Technology* (Torrens University), a subject focused on building software prototypes using middleware and emerging technologies.
This repository is a curated, cleaned-up version of the original coursework, prepared for portfolio purposes. Minor issues — hardcoded values, leftover debug logging, missing dependency files, and outdated documentation — have been reviewed and fixed after the original submission.
